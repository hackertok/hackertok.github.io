...
describe('storiesCache', () => {
  ...
  const mockStories = [
    createStory({ id: 1, title: 'Story 1', points: 100 }),
    createStory({ id: 2, title: 'Story 2', points: 200 }),
    createStory({ id: 3, title: 'Story 3', points: 300 }),
  ];
  ...
  describe('setCachedStories', () => {
    ...
    it('stores different cache types separately', () => {
      setCachedStories('top', [createStory({ id: 1, title: 'Top Story' })]);
      setCachedStories('best', [createStory({ id: 2, title: 'Best Story' })]);
