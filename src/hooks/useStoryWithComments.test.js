...
const testComments = [
  { id: 1001, text: 'Comment 1', by: 'user1', children: [] },
  { id: 1002, text: 'Comment 2', by: 'user2', children: [] },
];
...
describe('useStoryWithComments', () => {
  ...
  describe('refresh function', () => {
    it('provides a refresh function that reloads data', async () => {
      ...
      const _originalTitle = result.current.story.title;
  ...
  describe('loading states', () => {
    ...
    it('combined loading is true only when both are loading', async () => {
      setCachedStory(12345, testStory, null, 0); // Story cached, no comments
  ...
  describe('storyId change to cached story', () => {
    it('syncs state when storyId changes to a different fully-cached story', async () => {
      ...
      const storyA = { id: 11111, title: 'Story A', url: 'https://a.com', points: 10, author: 'userA', createdAt: Date.now(), commentCount: 1 };
      const storyB = { id: 22222, title: 'Story B', url: 'https://b.com', points: 20, author: 'userB', createdAt: Date.now(), commentCount: 2 };
      const commentsA = [{ id: 1001, text: 'Comment for story A', by: 'commenterA', children: [] }];
      const commentsB = [{ id: 2001, text: 'Comment for story B', by: 'commenterB', children: [] }];
  ...
  describe('storyId change to UNCACHED story', () => {
    it('resets state when storyId changes to an uncached story', async () => {
      ...
      const storyA = { id: 33333, title: 'Cached Story A', url: 'https://example1.com', points: 100, author: 'user1', createdAt: Date.now(), commentCount: 5 };
      const commentsA = [{ id: 3001, text: 'Comment for cached A', by: 'commenter1', children: [] }];
