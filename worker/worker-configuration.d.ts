/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: 51a7405df90144ec1c59150c3712a876)
// Runtime types generated with workerd@1.20260714.1 2026-07-19 
interface __BaseEnv_Env {
	PUSH_DB: D1Database;
	FANOUT_QUEUE: Queue;
	DELIVERY_QUEUE: Queue;
	PUSH_READ_RATE_LIMITER: RateLimit;
	PUSH_WRITE_RATE_LIMITER: RateLimit;
	PUSH_TEST_RATE_LIMITER: RateLimit;
	ALLOWED_ORIGINS: "https://hackertok.github.io,http://localhost:4173,http://localhost:5173";
	RELAY_HOST_ALLOWLIST: "fcm.googleapis.com,updates.push.services.mozilla.com,push.services.mozilla.com,*.notify.windows.com,*.push.apple.com";
	VAPID_PUBLIC_KEY: "";
	VAPID_KEY_ID: "v1";
	VAPID_SUBJECT: "https://hackertok.github.io/";
	RELEASE_VERSION: "development";
	SUBSCRIPTION_CAP: "350";
	STORY_THRESHOLD: "1000";
